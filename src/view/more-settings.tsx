    ...
    <div className="space-y-6">
      <Card>
        <CardContent className="flex items-center justify-between py-1">
          ...
          <Switch id="notifications" checked={theme === "dark"} onCheckedChange={(checked) => updateConfig({ theme: checked ? "dark" : "light" })} />
        </CardContent>
      </Card>
      <div className="space-y-1">
        <Button variant="ghost" className="w-full justify-between h-auto py-3" onClick={() => {
      ...
      <div className="text-center space-y-1">
        <p className="text-xs text-muted-foreground pb-2">本项目为<b>非官方实现</b>，与哔哩哔哩官方无任何关联</p>
